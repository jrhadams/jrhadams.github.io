...
siteMeta :: SiteMeta
siteMeta =
    SiteMeta { siteAuthor = "James Adams"
             , baseUrl = "https://jrhadams.github.io"
             , siteTitle = "Breeding, Statistics, & Computational Musings"
             , twitterHandle = Just "noTweets"
             , githubUser = Just "jrhadams"
             }
